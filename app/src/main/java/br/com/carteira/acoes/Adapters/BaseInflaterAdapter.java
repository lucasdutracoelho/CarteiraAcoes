...
public class BaseInflaterAdapter<T> extends BaseAdapter {
    ...
    private AdapterViewInflater<T> m_viewInflater;

    public BaseInflaterAdapter(AdapterViewInflater<T> viewInflater)
    {
        m_viewInflater = viewInflater;
    }

    public BaseInflaterAdapter(List<T> items, AdapterViewInflater<T> viewInflater)
    {
        m_items.addAll(items);
        m_viewInflater = viewInflater;
    }

    public void setViewInflater(AdapterViewInflater<T> viewInflater, boolean notifyChange)
    {
        m_viewInflater = viewInflater;
